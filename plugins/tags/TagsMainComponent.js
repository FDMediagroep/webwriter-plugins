...
TagsMainComponent.Prototype = function () {
    this.getInitialState = function () {
        return {
            existingTags: this.context.api.getTags(this.name)
        };
    };
    ...
    this.render = function () {
        ...
        var el = $$('div').ref('tagContainer').addClass('authors').append($$('h2').append(this.context.i18n.t('Tags')));
        ...
        var searchComponent = $$(SearchComponent, {
            ...
            placeholderText: this.context.i18n.t('Search tags'),
            createAllowed: false
        }).ref('searchComponent');
